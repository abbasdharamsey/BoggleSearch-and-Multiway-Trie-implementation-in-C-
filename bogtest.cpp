...
// //   // for (string head : fullLex) {
// //   //   if (!p->isInLexicon(head)) {
// //   //     cerr << "Lexicon test failed" << endl;
// //   //     return -1;
// //   //   }
// //   // }
...
// //   string row0[] = {"e","A", "b", "i", "p"};
// //   string row1[] = {"c","n", "o", "z", "a"};
// //   string row2[] = {"e","l", "u", "h", "re"};
// //   string row3[] = {"qu", "a", "v", "x", "s"};
// //   string row4[] = {"nam", "f", "o", "e", "y"};
// //   string* board1[] = {row0,row1,row2, row3, row4};
// //   p->setBoard(5,5,board1);

// //   p->buildLexicon(fullLex);
// //   set<string> testWords;
// //   if (!p->getAllValidWords(7, &testWords)) {
// //       cerr << "get all words error" << endl;
// //       return -1;
// //   }
...
// //   // locations.clear();
// //   // locations = p->isOnBoard(wordDAC);
// //   // if (locations.size() != 3 || locations[0] != 0 || locations[1] != 1 || locations[2] != 3) {
// //   //   std::cerr << "Apparent problem with isOnBoard #4." << std::endl;
// //   //   return -1;
// //   // }

// //   // locations.clear();
// //   // locations = p->isOnBoard(wordDBS);
// //   // if (locations.size() != 3 || locations[0] != 0 || locations[1] != 2 || locations[2] != 4) {
// //   //   std::cerr << "Apparent problem with isOnBoard #5." << std::endl;
// //   //   return -1;
// //   // }

// //   // locations.clear();
// //   // if(!p->getAllValidWords(1, &lex))
...
//         }
//         else
//             cout << "isOnBoard passed for " << testString << endl;
...
int main(int argc, char *argv[])
{
    ...
    {
        cout <<"valid: " << validWords.size() << "   results: " << results.size() << endl;
